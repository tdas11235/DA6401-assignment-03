...
def load_config(path="vanilla_config.yaml"):
...
def sweep_func():
    ...
    train_loader, input_vocab, target_vocab = get_dataloader(TRAIN_PATH, batch_size=256, shuffle=True, resample=True)
